...
const Catalog = () => {
  ...
  const fetchAllPerfumes = async () => {
    try {
      ...
      const perfumesData = response.data || response || [];
      ...
      console.log("All perfumes response:", response);
      console.log("Perfumes data extracted:", perfumesData);

      // Validate and clean the data before storing
      const cleanedData = perfumesData.map((perfume) => ({
        ...perfume,
