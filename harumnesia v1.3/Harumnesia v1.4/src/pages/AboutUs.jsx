        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            <p className="font-inter text-white leading-relaxed">
              ...
              dunia parfum lokal Indonesia. Sejak 2025, Harumnesia hadir
            ...
            <p className="font-inter text-white leading-relaxed">
              ...
              Harumnesia di kontak@harumnesia.com agar produk Anda dikenal lebih
              luas. Informasi detail produk Anda membantu kami menyajikannya
              secara optimal.
            </p>
