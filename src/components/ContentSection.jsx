      ...
      <div className="relative bg-gradient-to-br from-white via-white to-cream rounded-2xl overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.2)] hover:shadow-[0_35px_80px_-12px_rgba(0,0,0,0.3)] transition-all duration-700 transform hover:-translate-y-4 hover:scale-[1.02] border border-gold/20 hover:border-gold/40">
        ...
        <div className="relative overflow-hidden">
          <img
            src={imgSrc}
            alt={name}
            className="w-full h-56 xs:h-64 sm:h-72 md:h-64 lg:h-72 object-cover transition-transform duration-700 group-hover:scale-110"
          />
          {/* Gradient overlay */}
        ...
        <div className="p-4 xs:p-6 sm:p-8 md:p-6 lg:p-8">
          <div className="mb-4 xs:mb-6">
            <h3 className="text-dark-blue font-inter font-semibold text-sm xs:text-base sm:text-lg tracking-wide uppercase mb-1 xs:mb-2 group-hover:text-gold transition-colors duration-300">
              {brand}
            </h3>
            <h2 className="font-playfair font-bold text-xl xs:text-2xl sm:text-3xl md:text-2xl lg:text-3xl xl:text-4xl text-dark-gray mb-2 xs:mb-4 leading-tight group-hover:text-dark-blue transition-colors duration-300">
              {name}
            </h2>
          </div>

          <div className="flex justify-between items-center">
            <span className="bg-gradient-to-r from-dark-gray to-black text-white font-inter font-bold px-3 xs:px-4 sm:px-5 py-2 xs:py-3 rounded-lg xs:rounded-xl text-sm xs:text-base sm:text-lg shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
              {price}
            </span>
