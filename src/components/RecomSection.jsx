        ...
        <div className="relative bg-gradient-to-br from-white via-cream to-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 text-center shadow-[0_20px_40px_-10px_rgba(0,0,0,0.2)] sm:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.25)] md:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)] border border-gold/20 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link to="/recommendation-method">
              <button className="group relative bg-gradient-to-r from-gold via-gold to-gold/90 text-dark-gray font-inter font-bold w-full sm:w-auto px-8 sm:px-10 md:px-12 py-4 sm:py-5 md:py-6 rounded-xl sm:rounded-2xl text-lg sm:text-xl xl:text-2xl shadow-lg border-2 border-gold/30 hover:border-dark-blue transform-gpu will-change-transform transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-xl overflow-hidden">
                <span className="relative z-10 flex items-center justify-center">
                  Mulai Rekomendasi
                  <svg
                    className="ml-3 sm:ml-4 w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 transform transition-transform duration-200 group-hover:translate-x-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-white/20 to-white/10 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-300"></div>
              </button>
            </Link>
